...
adam = keras.optimizers.Adam(learning_rate=0.001)     # updating the model's weights during training to minimize the defined loss
...
basic_model.summary()
#basic_model.save(path)   #save the model in a .keras file of .h5 file
basic_model.save(path)